...
class Data:
    ...
    def has_unlocked_nodes(self):
        return self.__blocks[0].has_unlocked_nodes() or self.__blocks[1].has_unlocked_nodes()
    ...
    def print_blocks_size(self):
        logging.debug("block 0: {}, block 1: {}".format(self.__blocks[0].size(), self.__blocks[1].size()))
